QUERIES = {
    ...
    'Visualizza ritiri in un mese': 'SELECT n.cod_ordine, n.cod_negozio, o.data_effettuazione, o.data_arrivo FROM ordini_no_spedizione n, ordini o WHERE YEAR(o.data_effettuazione) = %s AND MONTH(o.data_effettuazione)  = %s AND o.cod_ordine = n.cod_ordine',
