QUERIES = {
    ...
    'Effettua ordine': 'INSERT INTO ordini (cod_ordine, data_effetuazione, costo_totale, peso_totale, sconto_totale, data_arrivo, cod_cliente, cod_tecnico_commerciale) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)',
    ...
    'Effettua ordini con montaggio': 'INSERT INTO ordini_con_montaggio(cod_ordine, indirizzo, cf_tecnico) VALUES (%s, %s, %s)',
    'Effettua ordini senza montaggio': 'INSERT INTO ordini_no_montaggio(cod_ordine) VALUES (%s)',
