QUERIES = {
    ...
    'Visualizza ritiri in un mese' : 'SELECT o.cod_ordine, o.data_effettuazione, o.data_arrivo FROM ordini o WHERE NOT EXISTS (SELECT s.cod_ordine FROM spedizioni s WHERE s.cod_ordine = o.cod_ordine) AND YEAR(o.data_effettuazione) = %s AND MONTH(o.data_effettuazione) = %s',
